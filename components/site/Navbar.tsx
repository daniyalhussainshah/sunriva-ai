...
export function Navbar() {
  ...
  return (
    <header className="sticky top-0 z-50 w-full">
      <div className={`mx-auto mt-4 flex h-14 max-w-6xl items-center justify-between rounded-full px-3 pl-5 pr-2 transition-all duration-300 ${scrolled ? "glass shadow-[0_10px_40px_-20px_rgba(0,0,0,0.6)]" : "bg-white/[0.02] border border-white/5"}`}
